...
const projects: Project[] = [
  ...
  //         <p className="font-mono mb-2">
  //           Powered by Spring, this bad boy allows us to keep the content
  ...
  // },
  {
    ...
    screenshots: ["1.png"],
    live: "https://daizuongkk.id.vn",
    github: "https://github.com/daizuongkk/Portfolio",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
  ...
  //   skills: {
  //     frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.spring],
  //     backend: [
  //       PROJECT_SKILLS.node,
