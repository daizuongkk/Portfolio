...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "trongdaidt147@gmail.com",
    href: "mailto:trongdaidt147@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/daizuongkk/",
    content: "/daizuongkk",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/daizuongkk",
    content: "/daizuongkk",
...
const TOOLS = [
  ...
  },
  {
    name: "SpringBoot",
    content: "Next.js is a React framework for production",
    icon: <SiSpring size={"50px"} color="#41b883" />,
    color: "#41b883",
  },
  {
    name: "Express.js",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Daizuongkk</p>
