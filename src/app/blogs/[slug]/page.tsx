...
const components = {
  h1: (props: any) => (
    <h1
      className="text-3xl md:text-5xl font-bold mt-12 mb-6 text-zinc-100"
      {...props}
    />
  ),
  h2: (props: any) => (
    <h2
      className="text-2xl md:text-3xl font-semibold mt-10 mb-4 text-zinc-200"
      {...props}
    />
  ),
  h3: (props: any) => (
    <h3
      className="text-xl md:text-2xl font-semibold mt-8 mb-3 text-zinc-300"
      {...props}
    />
  ),
  p: (props: any) => (
  ...
  ul: (props: any) => (
    <ul
      className="list-disc list-inside mb-6 text-zinc-400 space-y-2"
      {...props}
    />
  ),
  ol: (props: any) => (
    <ol
      className="list-decimal list-inside mb-6 text-zinc-400 space-y-2"
      {...props}
    />
  ),
  ...
  code: (props: any) => (
    <code
      className="bg-zinc-900 text-purple-300 px-1.5 py-0.5 rounded text-sm font-mono"
      {...props}
    />
  ),
  pre: (props: any) => (
    <pre
      className="bg-zinc-950 p-4 rounded-lg overflow-x-auto mb-6 border border-zinc-800"
      {...props}
    />
  ),
  a: (props: any) => (
